...
public class AutoSetupService {
	...
	private List<Customer> dummyCustomers = Arrays.asList(new Customer("1111", "Ronnie", "Raygun"), new Customer("2222", "P.M.", "Satcher"),
				new Customer("3333", "Infidel", "Castro"), new Customer("4444", "Col. Malomar", "Khadaffy"),
				new Customer("5555", "Ayatollah", "Kookamamie"), new Customer("6666", "Mao", "the Pun"),
				new Customer("7777", "Jimi", "Farmer"), new Customer("8888", "Tricky", "Dick"),
				new Customer("9999", "Mikhail", "Gorabachef"), new Customer("1010", null, "Ghanji"));
